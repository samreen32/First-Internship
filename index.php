<?php
 ...
 if(isset($_POST) & !empty($_POST)){
	 ...
	 $res = $database->create($title, $fname, $lname, $gender, $address, $address2, $city, $state, $zip, $textarea);
	 if($res){
            ...
            <h4>Personal Information</h4>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        name="fname" placeholder="e.g. Samreen">
                    </div>
                    <div class="form-group col-md-5">
                        <label for="lname">Last Name</label>
                        <input type="text" class="form-control" id="lname" 
                        name="lname" placeholder="e.g. Karim">
                    </div>
                </div>
